		  ...
		  <div class="card-body p-3">
			...
			<div class="row">
				<div class="col">
					...
					<input type="text" name="id" hidden value="{{$expense->id}}">
					<div class="row mb-3">
						...
						<div class="col">
							...
							<option value="{{$expense->expenseType->id}}" selected="" >{{$expense->expenseType->expenseType}}</option>
						...
						<div class="row mb-3">
							...
							<div class="col"><input class="form-control" type="number" id="amount" name="amount" required="" value="{{$expense->amount}}">
						</div>	
						</div>
				...
				<div class="col">
					...
					<div class="row mb-3">
						...
						<div class="col"><select id="location" name="location" class="js-example-basic-single form-control">
							<option selected="" value="{{$expense->location}}">{{$expense->location}}</option>
